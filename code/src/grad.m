...
% In order to obtain vector field of desired directions one must find  %
...
% written and it allows to cope with the problem in effective way.     %
%                                                                      %
% INPUT arguments:                                                     %
% A-input matrix                                                       %
% OUTPUT arguments:                                                    %
% e_x - gradient in x-direction                                        %
% e_y - gradient in y-direction                                        %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
